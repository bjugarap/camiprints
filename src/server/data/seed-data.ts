...
const extra = (slug: string, name: string, order: number): Category => ({
  slug,
  name,
  tint: null,
  thumbnailUrl: null,
...
export const seedCategories: Category[] = [
  featured("animals", "Animals", 1),
  featured("dinosaurs", "Dinosaurs", 2),
  featured("ocean", "Ocean", 3),
  featured("space", "Space", 4),
  featured("fantasy", "Fantasy", 5),
  featured("vehicles", "Vehicles", 6),
  featured("nature", "Nature", 7),
  featured("holidays", "Holidays", 8),
  extra("birds", "Birds", 9),
  extra("insects", "Insects", 10),
  extra("farm", "Farm", 11),
  extra("food", "Food", 12),
  extra("sports", "Sports", 13),
  extra("music", "Music", 14),
  extra("weather", "Weather", 15),
  extra("seasons", "Seasons", 16),
  extra("flowers", "Flowers", 17),
  extra("trucks", "Trucks", 18),
  extra("trains", "Trains", 19),
  extra("planes", "Planes", 20),
  extra("castles", "Castles", 21),
  extra("pirates", "Pirates", 22),
  extra("robots", "Robots", 23),
  extra("shapes", "Shapes & Patterns", 24),
];
